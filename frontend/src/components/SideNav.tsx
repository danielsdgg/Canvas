  ...
  return (
    <IconContext.Provider value={{ size: '1.5em' }}>
      ...
      <nav
        ...
        } transition-transform duration-300 md:translate-x-0 md:flex md:flex-col md:justify-start`}
      >
        ...
        <Link to="/account" className="flex items-center p-4 hover:bg-gray-700">
