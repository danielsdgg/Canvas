...
const Lesson1: React.FC = () => {
  ...
  return (
    <>
      <SideNav />
      <section className="min-h-screen bg-gradient-to-br from-indigo-900 via-gray-800 to-gray-900 text-gray-100 p-4 sm:p-6 md:p-8 flex flex-col items-center">
        {/* Back Button */}
        <button
          onClick={() => navigate(-1)}
        ...
        <div className="max-w-4xl mx-auto text-center mb-6 sm:mb-8">
          <h1 className="underline text-2xl sm:text-3xl md:text-4xl font-bold text-teal-400 uppercase tracking-wide">
        ...
        {/* Weeks Section */}
        <div className="max-w-4xl w-full mx-auto bg-indigo-900/30 backdrop-blur-md shadow-xl rounded-lg p-6 sm:p-8 border border-indigo-500/20 transition-all duration-300 hover:shadow-2xl">
            ...
            <div
              ...
              className={`cursor-pointer px-4 py-2 rounded-md transition-all duration-300 text-center text-sm sm:text-lg font-medium ${
                openWeek === 1
                  ...
                  : "bg-indigo-800/50 text-indigo-300 hover:bg-indigo-500 hover:text-white"
              }`}
            >
              Week 1: Introduction
            </div>
          ...
          <div>
            {openWeek === 1 && (
              <div className="space-y-6">
                {/* Day 1 */}
                <div className="bg-indigo-800/20 shadow-lg rounded-lg p-4 sm:p-6 border border-indigo-500/30 hover:bg-indigo-700/20 transition duration-300">
                  <h3 className="text-lg sm:text-xl font-bold text-center text-indigo-300 mb-3 underline">
                    <Link to="/fdl1day1" className="hover:text-indigo-100 transition duration-200">
                ...
                <div className="bg-indigo-800/20 shadow-lg rounded-lg p-4 sm:p-6 border border-indigo-500/30 hover:bg-indigo-700/20 transition duration-300">
                  <h3 className="text-lg sm:text-xl font-bold text-center text-indigo-300 mb-3 underline">
                    <Link to="/fdl1day2" className="hover:text-indigo-100 transition duration-200">
                ...
                <div className="bg-indigo-800/20 shadow-lg rounded-lg p-4 sm:p-6 border border-indigo-500/30 hover:bg-indigo-700/20 transition duration-300">
                  <h3 className="text-lg sm:text-xl font-bold text-center text-indigo-300 mb-3 underline">
                    <Link to="/fdl1day3" className="hover:text-indigo-100 transition duration-200">
                ...
                <div className="bg-indigo-800/20 shadow-lg rounded-lg p-4 sm:p-6 border border-indigo-500/30 hover:bg-indigo-700/20 transition duration-300">
                  <h3 className="text-lg sm:text-xl font-bold text-center text-indigo-300 mb-3 underline">
                    <Link to="/fdl1day4" className="hover:text-indigo-100 transition duration-200">
                ...
                <div className="bg-indigo-800/20 shadow-lg rounded-lg p-4 sm:p-6 border border-indigo-500/30 hover:bg-indigo-700/20 transition duration-300">
                  <h3 className="text-lg sm:text-xl font-bold text-center text-indigo-300 mb-3 underline">
                    <Link to="/fdl1day5" className="hover:text-indigo-100 transition duration-200">
            ...
            {openWeek === 2 && (
              <div className="space-y-6">
                ...
                <div className="bg-indigo-800/20 shadow-lg rounded-lg p-4 sm:p-6 border border-indigo-500/30 hover:bg-indigo-700/20 transition duration-300">
                  <h3 className="text-lg sm:text-xl font-bold text-center text-indigo-300 mb-3 underline">
                    <Link to="/fdl1day6" className="hover:text-indigo-100 transition duration-200">
                ...
                <div className="bg-indigo-800/20 shadow-lg rounded-lg p-4 sm:p-6 border border-indigo-500/30 hover:bg-indigo-700/20 transition duration-300">
                  <h3 className="text-lg sm:text-xl font-bold text-center text-indigo-300 mb-3 underline">
                    <Link to="/fdl1day7" className="hover:text-indigo-100 transition duration-200">
                ...
                <div className="bg-indigo-800/20 shadow-lg rounded-lg p-4 sm:p-6 border border-indigo-500/30 hover:bg-indigo-700/20 transition duration-300">
                  <h3 className="text-lg sm:text-xl font-bold text-center text-indigo-300 mb-3 underline">
                    <Link to="/fdl1day8" className="hover:text-indigo-100 transition duration-200">
                ...
                <div className="bg-indigo-800/20 shadow-lg rounded-lg p-4 sm:p-6 border border-indigo-500/30 hover:bg-indigo-700/20 transition duration-300">
                  <h3 className="text-lg sm:text-xl font-bold text-center text-indigo-300 mb-3 underline">
                    <Link to="/fdl1day9" className="hover:text-indigo-100 transition duration-200">
                ...
                <div className="bg-indigo-800/20 shadow-lg rounded-lg p-4 sm:p-6 border border-indigo-500/30 hover:bg-indigo-700/20 transition duration-300">
                  <h3 className="text-lg sm:text-xl font-bold text-center text-indigo-300 mb-3 underline">
                    <Link to="/fdl1day10" className="hover:text-indigo-100 transition duration-200">
                      Day 10: Flexbox & Grid
                    </Link>
                  </h3>
                  <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
            ...
            {openWeek === 3 && (
              <div className="space-y-6">
                ...
                <div className="bg-indigo-800/20 shadow-lg rounded-lg p-4 sm:p-6 border border-indigo-500/30 hover:bg-indigo-700/20 transition duration-300">
                  <h3 className="text-lg sm:text-xl font-bold text-center text-indigo-300 mb-3 underline">
                    <Link to="/fdl1day11" className="hover:text-indigo-100 transition duration-200">
                ...
                <div className="bg-indigo-800/20 shadow-lg rounded-lg p-4 sm:p-6 border border-indigo-500/30 hover:bg-indigo-700/20 transition duration-300">
                  <h3 className="text-lg sm:text-xl font-bold text-center text-indigo-300 mb-3 underline">
                    <Link to="/fdl1day12" className="hover:text-indigo-100 transition duration-200">
